...
public class ExplosiveArrow extends ItemLeader {
    ...
    public ExplosiveArrow(Item64 item64, ConfigHandler configHandler, Economy ecoHook, GDHook gdHook, DCHook dcHook) {
    ...
    private void triggerExplosiveArrow(Player player, Arrow arrow, ItemEntry entry) {
        ...
        arrow.setMetadata("Item64-keyString", new FixedMetadataValue(item64, entry.getKeyString()));
